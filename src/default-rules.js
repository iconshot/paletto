...
function createRules(pairs, property) {
...
module.exports = [
  ...
  new Rule("list-type-{value}", (value) => ({ "list-style-type": value })),
  ...
  new Rule("text-transform-{value}", (value) => ({ "text-transform": value })),
  ...
  new Rule("text-overflow-{first}", (first) => ({ "text-overflow": first })),
  ...
  new Rule("text-indent-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("text-shadow-{first}-{second}-{third}", (first, second, third) => ({
    "text-shadow": `${Value.parse(first)} ${Value.parse(second)} ${Value.parse(
      third
    )} var(--paletto-text-shadow-color)`,
  })),
  ...
  new Rule("columns-{first}", (first) => ({ columns: Value.parse(first) })),
  ...
  new Rule("break-before-{value}", (value) => ({ "break-before": value })),

  // break inside

  new Rule("break-inside-{value}", (value) => ({ "break-inside": value })),

  // writing mode

  new Rule("writing-mode-{value}", (value) => ({ "writing-mode": value })),
  ...
  new Rule("box-{value}", (value) => ({ "box-sizing": value })),
  ...
  new Rule("object-{first}", (first) => ({
    "object-position": Value.parse(first),
  })),

  new Rule("object-{first}-{second}", (first, second) => ({
  ...
  new Rule("overscroll-{first}", (first) => ({ "overscroll-behavior": first })),
  ...
  new Rule("bottom-{value}", (value) => ({ bottom: Value.parse(value) })),
  ...
  new Rule("flex-direction-{value}", (value) => ({ "flex-direction": value })),
  ...
  new Rule("justify-self-{first}", (first) => ({ "justify-self": first })),
  ...
  new Rule("place-content-{first}", (first) => ({ "place-content": first })),
  ...
  new Rule("place-items-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("place-self-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("min-w-{value}", (value) => ({ "min-width": Value.parse(value) })),

  // max width

  new Rule("max-w-{value}", (value) => ({ "max-width": Value.parse(value) })),
  ...
  new Rule("min-h-{value}", (value) => ({ "min-height": Value.parse(value) })),

  // max height

  new Rule("max-h-{value}", (value) => ({ "max-height": Value.parse(value) })),
  ...
  new Rule("bg-origin-{value}", (value) => ({ "background-origin": value })),
  ...
  new Rule("bg-position-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("bg-repeat-{first}", (first) => ({ "background-repeat": first })),
  ...
  new Rule("bg-image-{value}", (value) => ({ "background-image": value })),
  ...
  new Rule("border-spacing-{value}", (value) => ({
    "border-spacing": Value.parse(value),
  })),
  ...
  new Rule("border-style-{value}", (value) => ({ "border-style": value })),
  ...
  new Rule("outline-style-{value}", (value) => ({ "outline-style": value })),
  ...
  new Rule("mix-blend-{value}", (value) => ({ "mix-blend-mode": value })),

  // background blend mode

  new Rule("bg-blend-{value}", (value) => ({ "background-blend-mode": value })),
  ...
  new Rule("contrast-{value}", (value) => ({ filter: `contrast(${value})` })),
  ...
  new Rule("drop-shadow-{first}-{second}-{third}", (first, second, third) => ({
    filter: `drop-shadow(${Value.parse(first)} ${Value.parse(
      second
  ...
  new Rule("grayscale-{value}", (value) => ({ filter: `grayscale(${value})` })),
  ...
  new Rule("invert-{value}", (value) => ({ filter: `invert(${value})` })),

  // saturate

  new Rule("saturate-{value}", (value) => ({ filter: `saturate(${value})` })),
  ...
  new Rule("transition-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("animation-name-{value}", (value) => ({ "animation-name": value })),
  ...
  new Rule("animation-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("transform-box-{value}", (value) => ({ "transform-box": value })),
  ...
  new Rule("scale-x-{value}", (value) => ({ transform: `scaleX(${value})` })),

  new Rule("scale-y-{value}", (value) => ({ transform: `scaleY(${value})` })),

  new Rule("scale-z-{value}", (value) => ({ transform: `scaleZ(${value})` })),

  new Rule("scale-3d-{first}-{second}-{third}", (first, second, third) => ({
    transform: `scale3d(${first}, ${second}, ${third})`,
  })),

  new Rule("scale-{first}", (first) => ({ transform: `scale(${first})` })),
  ...
  new Rule("rotate-x-{value}", (value) => ({ transform: `rotateX(${value})` })),

  new Rule("rotate-y-{value}", (value) => ({ transform: `rotateY(${value})` })),

  new Rule("rotate-z-{value}", (value) => ({ transform: `rotateZ(${value})` })),
  ...
  new Rule("rotate-{value}", (value) => ({ transform: `rotate(${value})` })),
  ...
  new Rule("translate-3d-{first}-{second}-{third}", (first, second, third) => ({
  ...
  new Rule("skew-x-{value}", (value) => ({ transform: `skewX(${value})` })),

  new Rule("skew-y-{value}", (value) => ({ transform: `skewY(${value})` })),
  ...
  new Rule("pointer-events-{value}", (value) => ({ "pointer-events": value })),
  ...
  new Rule("touch-{value}", (value) => ({ "touch-action": value })),

  // user select

  new Rule("select-{value}", (value) => ({ "user-select": value })),

  // will change

  new Rule("will-change-{value}", (value) => ({ "will-change": value })),

  new Rule("testing", null),
];
